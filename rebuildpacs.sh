...
for package in installation-images rpmlint rpmlint-mini bundle-lang-common bundle-lang-kde bundle-lang-gnome kio_sysinfo-branding-upstream glib2-branding-openSUSE PackageKit-branding-openSUSE kiwi-config-openSUSE xfce4-branding-openSUSE kdebase4-openSUSE branding-openSUSE branding-basedonopensuse; do
