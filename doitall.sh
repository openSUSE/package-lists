...
#./mk_group.sh output/opensuse/dvd-ppc.list DVD-ppc osc/openSUSE\:11.2/_product/DVD5-ppc.group only_ppc
...
./mk_group.sh output/opensuse/promo_dvd.i586.list REST-DVD-promo-i386 osc/openSUSE\:11.2/_product/DVD5-promo-i386.group
